        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Danh sách tăng ca</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    FROM tangca as a,nhanvien as b
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Xóa tăng ca của nhân viên <?php echo $arUser["ten"] ?> ngày <?php echo date("d-m-Y", strtotime($arUser["ngay"])) ?>
                                                                <form action="xuly.php" method="post">
                                                                    ...
                                                                    <div class="modal-footer" style="margin-top: 20px">
                                                                        ...
                                                                        <button style="width:100px" type="submit" class="btn btn-danger" name="deletetc"> Xóa</button>
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="xuly.php" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <label for="category-film" class="col-form-label">Số giờ tăng ca:</label>
                                                                        <input type="number" min="1" max="8" value="<?php echo $arUser["so_gio"] ?>" class="form-control" id="category-film" name="sogio" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" name="edittc">Lưu</button>
                                                    </div>
                                                    </form>
                                                </div>
                                    ...
                                    <form action="xuly.php" method="POST" enctype="multipart/form-data">
                                        <div class="col">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="category-film" class="col-form-label">Số giờ tăng ca:</label>
                                                    <input type="number" min="1" max="8" class="form-control" id="category-film" name="sogio" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                                            <button type="submit" class="btn btn-primary" name="addtc">Lưu </button>
                                        </div>
                                    </form>
                                </div>
